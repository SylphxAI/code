...
INSERT INTO `__new_file_contents`("id", "step_id", "ordering", "relative_path", "media_type", "size", "content", "storage_key", "is_text", "text_content", "sha256", "created_at") SELECT "id", "step_id", "ordering", "relative_path", "media_type", "size", "content", "storage_key", "is_text", "text_content", "sha256", "created_at" FROM `file_contents`;--> statement-breakpoint
