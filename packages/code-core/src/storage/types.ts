...
export interface IStorage {
	 ...
	 * Returns Buffer if returnUrl=false, or signed URL if returnUrl=true
	 */
	...
	/**
	 * Get public URL for object (if supported)
	 * Returns null if storage doesn't support public URLs
	 */
