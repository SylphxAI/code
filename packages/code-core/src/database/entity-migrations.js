 ...
 */
export function migrateSessionToModelId(session) {
 ...
 */
export function migrateSessionMetadata(metadata) {
 ...
 */
export function migrateMessagePart(part) {
 ...
 */
export function migrateAIConfig(config) {
    const migrated = {
 ...
 */
export function batchMigrateSessions(sessions) {
    return sessions.map(migrateSession);
}
/**
 * Batch migrate message parts
 */
export function batchMigrateMessageParts(parts) {
    return parts.map(migrateMessagePart);
}
/**
 * Batch migrate todos
 */
export function batchMigrateTodos(todos) {
    return todos.map(migrateTodo);
}
/**
 * Get migration statistics for a session
 */
export function getSessionMigrationStats(session) {
...
//# sourceMappingURL=entity-migrations.js.map