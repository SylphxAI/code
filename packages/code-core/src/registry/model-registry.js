 ...
 */
export function getProviderEntity(providerId) {
 ...
 */
export function getModelWithProvider(modelId) {
 ...
 */
export function modelSupportsInput(modelId, capability) {
    const model = MODELS[modelId];
 ...
 */
export function modelSupportsOutput(modelId, capability) {
    const model = MODELS[modelId];
