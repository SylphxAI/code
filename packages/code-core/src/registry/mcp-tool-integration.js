 ...
 */
export function convertMCPToolToAISDK(mcpTool) {
 ...
 */
export function convertMCPToolToMetadata(mcpTool) {
    const toolId = `${mcpTool.serverId}__${mcpTool.name}`;
    return {
        id: toolId,
        name: mcpTool.name,
 ...
 */
export function registerMCPTool(mcpTool) {
 ...
 */
export function unregisterMCPTool(toolId) {
 ...
 */
export function unregisterMCPServerTools(serverId) {
    const toolsToRemove = [];
 ...
 * Get MCP tool by ID
 */
export function getMCPTool(toolId) {
 ...
 */
export function getMCPToolsByServerId(serverId) {
    const tools = [];
 ...
 */
export async function convertAllMCPToolsToAISDK() {
    const mcpManager = getMCPManager();
    const allTools = {};
 ...
 */
export function convertAllMCPToolsToMetadata() {
    const tools = [];
    for (const mcpTool of mcpToolRegistry.values()) {
 ...
 */
export async function reloadMCPServerTools(serverId) {
    const mcpManager = getMCPManager();
 ...
 */
export function getMCPToolCountByServer() {
    const counts = {};
    for (const mcpTool of mcpToolRegistry.values()) {
...
//# sourceMappingURL=mcp-tool-integration.js.map