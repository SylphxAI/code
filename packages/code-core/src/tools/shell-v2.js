...
All output is streamed in real-time via event channel "bash:{bash_id}"`,
    inputSchema: z.object({
        ...
        timeout: z
            ...
            .default(120000)
            .optional()
            .describe("Timeout in milliseconds for ACTIVE mode only. After timeout, bash auto-converts to background. Default: 120000 (2 minutes)"),
        run_in_background: z
            .boolean()
            .default(false)
            .optional()
            .describe("Run in background mode (spawns immediately, no queueing). Use for long-running tasks that don't need immediate attention."),
    }),
...
//# sourceMappingURL=shell-v2.js.map