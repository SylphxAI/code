 ...
 */
export const DEFAULT_TOOL_DISPLAY_SETTINGS = {
    // File tools
 ...
 */
export function getToolShowDetailsDefault(toolName) {
 ...
 */
export function shouldShowToolDetails(toolName, userSettings) {
 ...
 */
export function updateToolDisplaySetting(toolName, showDetails, currentSettings) {
    return {
        ...currentSettings,
 ...
 */
export function resetToolDisplaySetting(toolName, currentSettings) {
 ...
 */
export function resetAllToolDisplaySettings() {
    return {};
}
/**
 * Get display info for all tools
 */
export function getAllToolDisplayInfo(userSettings) {
...
//# sourceMappingURL=tool-display-settings.js.map