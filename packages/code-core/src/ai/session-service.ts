...
import { getConfiguredProviders, loadAIConfig } from "../config/ai-config.js";
...
export function showModelToolSupportError(): void {
	...
	console.error(
		chalk.dim("  • Some models can call tools but cannot process results and respond\n"),
	);
	...
	console.error(
		chalk.dim("💡 Tip: Ask questions that don't require tools, or switch to a model above"),
	);
