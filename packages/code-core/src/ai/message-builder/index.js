 ...
 */
export async function buildModelMessages(messages, modelCapabilities, fileRepo) {
    const results = [];
 ...
 */
async function buildUserMessage(msg, modelCapabilities, fileRepo) {
    const contentParts = [];
 ...
 */
async function buildAssistantMessageWithSteps(msg, modelCapabilities, fileRepo, results) {
    if (msg.steps && msg.steps.length > 0) {
 ...
 */
async function buildAssistantMessage(msg, modelCapabilities, _fileRepo, stepsOverride, results) {
