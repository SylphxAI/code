 ...
 */
const ANTHROPIC: ProviderModelRegistry = {
	models: [
 ...
 * OpenAI (GPT) Models
 */
const OPENAI: ProviderModelRegistry = {
	models: [
 ...
 */
const GOOGLE: ProviderModelRegistry = {
	models: [
 ...
 */
export function getProviderModels(providerId: StaticProviderID): ModelInfo[] {
 ...
 */
export function getProviderConsoleUrl(providerId: StaticProviderID): string | undefined {
 ...
 */
export function getProviderDocsUrl(providerId: StaticProviderID): string | undefined {
