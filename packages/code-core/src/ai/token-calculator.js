...
export class TokenCalculator {
     ...
     */
    async calculatePartTokens(part) {
        switch (part.type) {
            case "text":
            case "reasoning":
     ...
     */
    async calculateStepTokens(step) {
        let total = 0;
     ...
     */
    async calculateMessageTokens(message) {
        let total = 0;
     ...
     */
    async calculateSessionTokens(messages) {
        let total = 0;
     ...
     */
    async calculateDeltaTokens(deltaText) {
