 ...
 */
export function deleteCharLeft(value: string, cursor: number): { text: string; cursor: number } {
 ...
 */
export function deleteCharRight(value: string, cursor: number): { text: string; cursor: number } {
 ...
 */
export function transposeChars(value: string, cursor: number): { text: string; cursor: number } {
	// At start - do nothing
	if (cursor === 0) return { text: value, cursor };
