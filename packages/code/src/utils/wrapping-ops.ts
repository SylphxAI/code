 ...
 */
export function moveCursorUpPhysical(value: string, cursor: number, width: number): number {
 ...
 */
export function moveCursorDownPhysical(value: string, cursor: number, width: number): number {
