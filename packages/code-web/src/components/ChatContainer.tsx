...
export default function ChatContainer({ sessionId, toast }: ChatContainerProps) {
			...
			<div className="flex-1 flex flex-col bg-gray-950">
				...
				<div className="flex-1 flex items-center justify-center">
					<div className="text-center">
						...
						<h2 className="text-2xl font-bold text-gray-300 mb-2">Start a New Conversation</h2>
						<p className="text-gray-500">Type your message below to begin</p>
					</div>
				</div>
	...
	return (
		<div className="flex-1 flex flex-col bg-gray-950">
			...
			<div className="h-16 flex items-center px-8 bg-gray-900/30 backdrop-blur-sm">
				<div className="flex-1">
					<h2 className="text-lg font-semibold text-gray-100">{session.title || "New Chat"}</h2>
