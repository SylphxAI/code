...
describe('Session Domain Signals', () => {
  ...
  describe('Computed Signals', () => {
    ...
    it('should compute lastMessage correctly', () => {
      ...
      const message1 = { ...mockMessage, id: 'msg-1', content: [{ type: 'text', content: 'First' }] };
      const message2 = { ...mockMessage, id: 'msg-2', content: [{ type: 'text', content: 'Second' }] };
  ...
  describe('Message Management', () => {
    ...
    it('should not update non-existent messages', () => {
      ...
      session.updateMessage('non-existent', { content: [{ type: 'text', content: 'Should not update' }] });
  ...
  describe('Message Operations', () => {
    it('should add message via tRPC', async () => {
      ...
      (mockClient.message.add.mutate as any).mockResolvedValue({ sessionId: 'session-123' });
