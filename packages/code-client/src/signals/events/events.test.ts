...
describe("Event Bus", () => {
	...
	describe("Memory Management", () => {
		...
		it("should handle rapid subscribe/unsubscribe cycles", () => {
			...
			const unsubscribes = callbacks.map((callback) => eventBus.on("rapid-event", callback));
	...
	describe("Error Handling", () => {
		...
		it("should handle multiple callback errors", () => {
			...
			errorCallbacks.forEach((callback) => eventBus.on("multiple-errors", callback));
	...
	describe("Performance", () => {
		...
		it("should handle many concurrent listeners efficiently", () => {
			...
			callbacks.forEach((callback) => eventBus.on("many-listeners", callback));
