...
export const emitSessionEvent = <K extends keyof SessionEvents>(event: K, data: SessionEvents[K]) =>
	eventBus.emit(event, data);

export const emitAIEvent = <K extends keyof AIEvents>(event: K, data: AIEvents[K]) =>
	eventBus.emit(event, data);

export const emitUIEvent = <K extends keyof UIEvents>(event: K, data: UIEvents[K]) =>
	eventBus.emit(event, data);
