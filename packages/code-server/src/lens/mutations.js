...
export const sendMessage = mutation()
    ...
    const { triggerStreamMutation } = await import("../services/streaming-mutations.service.js");
...
export const abortStream = mutation()
    ...
    .resolve(async ({ input }) => {
    const { abortStreamMutation } = await import("../services/streaming-mutations.service.js");
