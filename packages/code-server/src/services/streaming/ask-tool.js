 ...
 */
export function createAskTool(sessionId, observer) {
    ...
    return tool({
        ...
        inputSchema: z.object({
            ...
            options: z
                ...
                freeText: z
                    .boolean()
                    .optional()
                    .describe('If true, selecting this option lets user type custom text instead of selecting from list. Use for "Other..." options'),
                placeholder: z
                    .string()
                    .optional()
                ...
                checked: z
                    .boolean()
                    .optional()
                    .describe("Default checked state (only for multiSelect). If true, option is pre-selected"),
            }))
                .min(1)
            ...
            multiSelect: z
                .boolean()
                .optional()
                .describe("Allow multiple selections. Returns comma-separated values. Use checked field to pre-select options"),
            preSelected: z
                .array(z.string())
                .optional()
                .describe("Pre-selected values for multi-select (question-level default). Use option.checked for per-option control"),
        }),
        execute: async ({ question, options, multiSelect, preSelected }, { toolCallId }) => {
            ...
            const answer = await enqueueAsk(sessionId, toolCallId, question, options, multiSelect, preSelected);
            return answer;
        },
    });
}
