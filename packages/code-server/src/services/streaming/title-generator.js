 ...
 */
export async function generateSessionTitle(appContext, sessionRepository, aiConfig, session, userMessage, callbacks) {
    try {
 ...
 */
export function needsTitleGeneration(session, isNewSession, isFirstMessage) {
