 ...
 */
import { AI_PROVIDERS, countTokens, fetchModels, getAIConfigPaths, getProvider, getProviderConfigWithApiKey, getTokenizerInfo, loadAIConfig, saveAIConfig, scanProjectFiles, } from "@sylphx/code-core";
import { z } from "zod";
...
export const configRouter = router({
    ...
    updateProviderConfig: moderateProcedure
        ...
        const mergedProviderConfig = { ...input.config };
    ...
    getModelDetails: publicProcedure
        ...
        try {
            ...
            const modelsDevData = await fetch("https://models.dev/api.json", {
                ...
                .catch(() => null);
            const enrichedCapabilities = enrichCapabilities(input.modelId, providerCapabilities, modelsDevData);
            return {
                success: true,
                details: {
                    ...enrichedDetails,
